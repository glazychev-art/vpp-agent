...
type PeerDescriptor struct {
	...
	Create               func(key string, value *vpp_wg.Peer) (metadata interface{}, err error)
	Delete               func(key string, value *vpp_wg.Peer, metadata interface{}) error
	Update               func(key string, oldValue, newValue *vpp_wg.Peer, oldMetadata interface{}) (newMetadata interface{}, err error)
	UpdateWithRecreate   func(key string, oldValue, newValue *vpp_wg.Peer, metadata interface{}) bool
...
func castPeerMetadata(key string, metadata Metadata) (interface{}, error) {
	if metadata == nil {
		return nil, nil
	}
